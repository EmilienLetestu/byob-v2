 ...
 */
final class Version20180731145341 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE family CHANGE added_by added_by INT DEFAULT NULL, CHANGE data data DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE make CHANGE added_by added_by INT DEFAULT NULL, CHANGE data data DATE DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE category CHANGE added_by added_by INT DEFAULT NULL, CHANGE data data DATE DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE type CHANGE added_by added_by INT DEFAULT NULL, CHANGE data data DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE designation CHANGE added_by added_by INT DEFAULT NULL, CHANGE data data DATE DEFAULT NULL');
