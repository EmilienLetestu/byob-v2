 ...
 */
final class Version20180731064405 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD token VARCHAR(255) DEFAULT NULL, CHANGE activated_on activated_on DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE person CHANGE user_id user_id INT DEFAULT NULL, CHANGE birthday birthday DATE DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE product CHANGE last_modification last_modification DATE DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE user DROP token, CHANGE activated_on activated_on DATE DEFAULT \'NULL\'');
    }
}
